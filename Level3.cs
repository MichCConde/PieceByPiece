...
namespace PiecebyPiece
{
    public partial class Level3 : Form
    {
        ...
        private void Level3TImer(object sender, EventArgs e)
        {
            ...
            //moves the platform sideways
            horizontalPlatform.Left += PBP.horizontalSpeed;
            if (horizontalPlatform.Left > 450 || horizontalPlatform.Left + horizontalPlatform.Width < 210)
            {
                PBP.horizontalSpeed = -PBP.horizontalSpeed;
            }

            //moves the platform up and down
            verticalPlatform.Top += PBP.verticalSpeed;
            if (verticalPlatform.Top < 100 || verticalPlatform.Top > 230)
            {
            ...
            if (Player.Bounds.IntersectsWith(Door.Bounds) && PBP.score == 3)
            {
                ...
                //Add achievement
                GlobalVar.Level3Achievement = true;
            }
        }
